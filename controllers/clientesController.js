...
$('#registrar_cliente')[0].reset();
document.querySelector(".modal-title").innerHTML = "Agregar Paciente";
...
document.querySelector(".modal-title").innerHTML = "Actualizar Paciente";
...
Swal.fire({
    title: 'Estas seguro?',
    text: "Deseas "+mensaje+" este Paciente!",
    icon: 'question',
