...
>
  <head>
    ...
    <link rel="icon" type="image/x-icon" href="<?= BASE_URL ?>assets/img/icontuips/tuips.png" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              <!-- <Imagen LOGO TUIPS"> -->
                <img src="../../assets/img/icontuips/tuips.png" class="d-block rounded mb-2" height="50" width="150">
              <!-- </span> -->
            </a>
